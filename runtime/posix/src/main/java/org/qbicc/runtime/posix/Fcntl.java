...
public class Fcntl {
    @name("open")
    private static native c_int open_impl(const_char_ptr pathname, c_int oflag, object... args);

    public static c_int open(const_char_ptr pathname, c_int flags) {
        return open_impl(pathname, flags);
    }

    public static c_int open(const_char_ptr pathname, c_int flags, mode_t mode) {
